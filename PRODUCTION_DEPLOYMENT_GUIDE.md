...
4. Run migrations from your terminal to initialize database tables:
   ...
   DATABASE_URL="YOUR_NEON_POOLED_CONNECTION_STRING" alembic upgrade head
   ```
...
Log in to [Railway](https://railway.app/), create a project, and link it to your GitHub repository `JawadSk12/CAPVIA` to deploy the 4 Python services.
...
| **CNAME** | `api` | `capvia-gateway.up.railway.app.` | 600s |
| **CNAME** | `ats-api` | `capvia-ats.up.railway.app.` | 600s |
| **CNAME** | `simulation-api`| `capvia-simulation.up.railway.app.` | 600s |
| **CNAME** | `interview-api` | `capvia-interview-eval.up.railway.app.` | 600s |
